<div class="overflow-x-auto">
    <div class="flex w-full p-3 space-x-2">
        ...
        <div class="w-3/6">
            ...
            focus:outline-none focus:shadow-outline focus-ring-0 foucus:bg-indigo-50" placeholder="Search Customers...">
        </div>
        <!-- Order By -->
    ...
    <table class="w-full text-base text-left text-gray-700 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">                                    
                ...
                <td class="py-4 px-6">
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium leading-4 bg-{{ $customer->status_color }}-100 text-{{ $customer->status_color }}-900 capitalize">
                        {{ $customer->status }}
                    </span>                                 
                </td>
                <td class="py-4 px-6">
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                <form method="POST" action="{{ route('customers.destroy', 'data_id') }}">
                    @csrf
                    @method('DELETE')
