...
<div>
    ...
    @csrf
        <input type="text" name="productid" value="{{ $product->id }}" wire:model="productid">
        <input type="text" name="stock" value="{{ $product->stock }}" wire:model="stock">
